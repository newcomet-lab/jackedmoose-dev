...
export const getCandyMachineState = async (
  ...
  const program = new anchor.Program(idl as Idl, CANDY_MACHINE_PROGRAM, provider);
...
export const mintMultipleToken = async (
  ...
  let signersMatrix: any[] = [];
  let instructionsMatrix: any[] = [];
